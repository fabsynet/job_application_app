...
**Plans**: 6 plans
  - [ ] 03-01-PLAN.md — DB models (Source, Job, DiscoveryRunStats) + Alembic migration
  - [ ] 03-02-PLAN.md — Discovery backend (fetchers, scoring, dedup, pipeline integration)
  - [ ] 03-03-PLAN.md — Sources settings UI (add/validate/toggle/remove in sidebar)
  - [ ] 03-04-PLAN.md — Jobs page UI (sortable table, inline expand, keyword highlight, manual queue)
  - [ ] 03-05-PLAN.md — Dashboard discovery summary + anomaly banners + run detail stats
  - [ ] 03-06-PLAN.md — Integration tests for all Phase 3 requirements
...
| 3. Safe-Channel Discovery, Dedup & Matching | 0/6 | Planning complete | - |
